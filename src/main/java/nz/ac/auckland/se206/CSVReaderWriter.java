...
public class CSVReaderWriter {
	public String findWordsLeft(String currentUsername) throws IOException, CsvException, URISyntaxException {
	...
	private void newFile(ArrayList<String> wordsLeftFormatted, Integer index) throws IOException, CsvException {
		CSVReader csvReader = new CSVReader(new FileReader("userdata.csv"));
		List<String[]> allData = csvReader.readAll();
