...
public class LoadPage {
	...
	public void extractedMainMenu(TextToSpeechBackground textToSpeechBackground, Boolean textToSpeech,
			String currentUsername, Stage stage) throws IOException, CsvException {
	...
	public void extractedLogin(TextToSpeechBackground textToSpeechBackground, boolean textToSpeech,
			String currentUsername, Stage stage) throws IOException, CsvException {
