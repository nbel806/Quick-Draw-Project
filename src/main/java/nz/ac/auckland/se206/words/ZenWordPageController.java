...
public class ZenWordPageController {
	...
	@FXML
	private Label lostWord1;
	@FXML
	private Label lostWord2;
	@FXML
	private Label lostWord3;
	@FXML
	private Label lostWord4;
	@FXML
	private Label lostWord5;
	@FXML
	...
	private void onBack() throws IOException, CsvException {
		...
		loadPage.extractedMainMenu(textToSpeechBackground, textToSpeech, currentUsername, currentProfilePic, stage);
	}
