...
public class WordPageController {
	...
	private void onHoverReady() {
		...
		readyButton.setStyle("-fx-background-radius: 15px; -fx-border-radius: 15px; -fx-background-color: #99F4B3;");
	}
	...
	private void onExitReady() {
		readyButton.setStyle("-fx-background-radius: 25px; -fx-border-radius: 25px; -fx-background-color: white;");
	}
