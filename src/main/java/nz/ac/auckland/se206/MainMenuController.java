...
public class MainMenuController {
	...
	private void onZenModeCanvas() throws IOException, CsvException {
		...
		FXMLLoader loader = new FXMLLoader(App.class.getResource("/fxml/zen_word_page.fxml")); // creates a new instance
		// of
		// word page
	...
	private void onProfile() throws IOException, CsvException {
		...
		loadPage.extractedProfile(textToSpeechBackground, textToSpeech, currentUsername, currentProfilePic, stage);
	}
